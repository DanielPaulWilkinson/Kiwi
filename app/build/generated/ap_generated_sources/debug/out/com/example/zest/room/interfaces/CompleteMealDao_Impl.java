          ...
          try {
            ...
            while(_cursor.moveToNext()) {
              ...
              if (! (_cursor.isNull(_cursorIndexOfMealId) && _cursor.isNull(_cursorIndexOfTitle) && _cursor.isNull(_cursorIndexOfCheap) && _cursor.isNull(_cursorIndexOfHealthScore) && _cursor.isNull(_cursorIndexOfVegetarian) && _cursor.isNull(_cursorIndexOfVegan) && _cursor.isNull(_cursorIndexOfGlutenFree) && _cursor.isNull(_cursorIndexOfVeryHealthy) && _cursor.isNull(_cursorIndexOfDairyFree) && _cursor.isNull(_cursorIndexOfVeryPopular) && _cursor.isNull(_cursorIndexOfSustainable) && _cursor.isNull(_cursorIndexOfPricePerServing) && _cursor.isNull(_cursorIndexOfSpoonId) && _cursor.isNull(_cursorIndexOfServings) && _cursor.isNull(_cursorIndexOfSourceUrl) && _cursor.isNull(_cursorIndexOfSummary) && _cursor.isNull(_cursorIndexOfImage) && _cursor.isNull(_cursorIndexOfReadyInMinutes) && _cursor.isNull(_cursorIndexOfDiets) && _cursor.isNull(_cursorIndexOfDishTypes) && _cursor.isNull(_cursorIndexOfOccasions) && _cursor.isNull(_cursorIndexOfLikes) && _cursor.isNull(_cursorIndexOfUsedIngredientCount) && _cursor.isNull(_cursorIndexOfCuisines) && _cursor.isNull(_cursorIndexOfIsSpoonacularMeal) && _cursor.isNull(_cursorIndexOfTotalCalories) && _cursor.isNull(_cursorIndexOfTimeOfDay) && _cursor.isNull(_cursorIndexOfComplexity))) {
                ...
                _tmpMeal.isSpoonacularMeal = _tmp_10 == null ? null : _tmp_10 != 0;
                if (_cursor.isNull(_cursorIndexOfTotalCalories)) {
                  _tmpMeal.totalCalories = null;
                } else {
                  _tmpMeal.totalCalories = _cursor.getDouble(_cursorIndexOfTotalCalories);
                }
              }  else  {
                _tmpMeal = null;
              }
      ...
      while(_cursor.moveToNext()) {
        if (!_cursor.isNull(_itemKeyIndex)) {
          ...
          if (_tmpRelation != null) {
            ...
            _item_1 = new Ingredients(_tmpIngredientsId,_tmpName,_tmpDescription,_tmpBrand,_tmpServingSize,_tmpUnit,_tmpCalories,_tmpEnergy,_tmpFat,_tmpOfWhichSaturates,_tmpFiber,_tmpProtein,_tmpSalt,_tmpSugar,_tmpFreezable,_tmpMicrowaveable,_tmpVegan,_tmpGlutenFree);
            if (_cursor.isNull(_cursorIndexOfSpoonId)) {
