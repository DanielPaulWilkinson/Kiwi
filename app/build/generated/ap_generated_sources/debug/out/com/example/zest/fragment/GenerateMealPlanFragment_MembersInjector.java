...
public final class GenerateMealPlanFragment_MembersInjector implements MembersInjector<GenerateMealPlanFragment> {
  ...
  public GenerateMealPlanFragment_MembersInjector(
  ...
  public static MembersInjector<GenerateMealPlanFragment> create(
      Provider<CompleteMealRepository> completeMealRepositoryProvider,
      Provider<CompletePlanRepository> completePlanRepositoryProvider,
      Provider<FixedThreadPool> fixedThreadPoolProvider,
      Provider<ImageProcessing> imageProcessingProvider) {
    return new GenerateMealPlanFragment_MembersInjector(completeMealRepositoryProvider, completePlanRepositoryProvider, fixedThreadPoolProvider, imageProcessingProvider);
  }

  @Override
  public void injectMembers(GenerateMealPlanFragment instance) {
  ...
  @InjectedFieldSignature("com.example.zest.fragment.GenerateMealPlanFragment.completeMealRepository")
  public static void injectCompleteMealRepository(GenerateMealPlanFragment instance,
      CompleteMealRepository completeMealRepository) {
    instance.completeMealRepository = completeMealRepository;
  }

  @InjectedFieldSignature("com.example.zest.fragment.GenerateMealPlanFragment.completePlanRepository")
  public static void injectCompletePlanRepository(GenerateMealPlanFragment instance,
      CompletePlanRepository completePlanRepository) {
    instance.completePlanRepository = completePlanRepository;
  }

  @InjectedFieldSignature("com.example.zest.fragment.GenerateMealPlanFragment.fixedThreadPool")
  public static void injectFixedThreadPool(GenerateMealPlanFragment instance,
      FixedThreadPool fixedThreadPool) {
    instance.fixedThreadPool = fixedThreadPool;
  }

  @InjectedFieldSignature("com.example.zest.fragment.GenerateMealPlanFragment.imageProcessing")
  public static void injectImageProcessing(GenerateMealPlanFragment instance,
